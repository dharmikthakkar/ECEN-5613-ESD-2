...
;	main.c:229: case 'M':
00171$:
;	main.c:230: printf_tiny("\rEnter the string. Press backspace (followed by enter) to exit to main menu\n");
;	genIpush
	mov	a,#__str_2
	push	acc
	mov	a,#(__str_2 >> 8)
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:231: mystring = rx_get_string();
;	genCall
	lcall	_rx_get_string
	mov	r2,dpl
	mov	r3,dph
	mov	r4,b
;	main.c:232: if(rx_array[0] == 0x08){
;	genPointerGet
;	genFarPointerGet
	mov	dptr,#_rx_array
	movx	a,@dptr
...
;	gencjneshort
	...
	ljmp	00180$
00255$:
;	main.c:235: search_string(mystring);
;	genCall
	mov	dpl,r2
	mov	dph,r3
	mov	b,r4
	lcall	_search_string
;	main.c:236: break;
	ljmp	00180$
;	main.c:237: case 'D':
00174$:
;	main.c:238: configure_IOE();
;	genCall
...
;	main.c:246: default:
00177$:
;	main.c:247: printf_tiny("\rInvalid input. Enter a valid input\n\r");
;	genIpush
	mov	a,#__str_9
	push	acc
	mov	a,#(__str_9 >> 8)
...
;------------------------------------------------------------
;	main.c:256: void timer0_zero(void) __interrupt (1)
;	-----------------------------------------
...
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00103$
00102$:
;	main.c:265: Test_pin = 1;
;	genAssign
	setb	_P1_1
00103$:
;	main.c:268: print_time_lcd(0, print_flag);
;	genAssign
	mov	dptr,#_print_flag
	movx	a,@dptr
;	genAssign
...
;------------------------------------------------------------
;	main.c:276: void isr_zero(void) __interrupt (0)
;	-----------------------------------------
;	 function isr_zero
;	-----------------------------------------
_isr_zero:
	...
	push	psw
	mov	psw,#0x00
;	main.c:279: printf_tiny("\rCount value=%x\n", count_value & 0x0F);
;	genAssign
	mov	dptr,#_count_value
	movx	a,@dptr
	mov	r2,a
...
;	genCall
	...
	add	a,#0xfc
	mov	sp,a
;	main.c:280: IOE_pins.P4_STATE = count_value & 0x01;
;	genAssign
	mov	dptr,#_count_value
	movx	a,@dptr
	mov	r2,a
...
;     genFarPointerSet
	...
	mov	a,r2
	movx	@dptr,a
;	main.c:281: IOE_pins.P5_STATE = (count_value & 0x02)>>1;
;	genAssign
	mov	dptr,#_count_value
	movx	a,@dptr
;	genAnd
...
;	Peephole 100	removed redundant mov
	movx	@dptr,a
;	main.c:282: IOE_pins.P6_STATE = (count_value & 0x04)>>2;
;	genAssign
	mov	dptr,#_count_value
	movx	a,@dptr
;	genAnd
...
;	Peephole 100	removed redundant mov
	movx	@dptr,a
;	main.c:283: IOE_pins.P7_STATE = (count_value & 0x08)>>3;
;	genAssign
	mov	dptr,#_count_value
	movx	a,@dptr
;	genAnd
...
;	Peephole 100	removed redundant mov
	movx	@dptr,a
;	main.c:284: temp = (IOE_pins.P0_STATE & P0_MASK) | ((IOE_pins.P1_STATE<<1) & P1_MASK) | ((IOE_pins.P2_STATE<<2) & P2_MASK) | ((IOE_pins.P3_STATE<<3) & P3_MASK) | ((IOE_pins.P4_STATE<<4) & P4_MASK) | ((IOE_pins.P5_STATE<<5) & P5_MASK) | ((IOE_pins.P6_STATE<<6) & P6_MASK) | ((IOE_pins.P7_STATE<<7) & P7_MASK);
;	genPointerGet
;	genFarPointerGet
	mov	dptr,#(_IOE_pins + 0x0008)
	movx	a,@dptr
...
;	genOr
	...
	orl	ar3,a
;	genCast
;	main.c:285: I2C_Write_IOE(temp);
;	genCall
	mov	dpl,r2
	lcall	_I2C_Write_IOE
;	main.c:286: count_value++;
;	genPlus
	mov	dptr,#_count_value
	movx	a,@dptr
	add	a,#0x01
