...
;------------------------------------------------------------
;	LCD.c:138: void wrap_cursor(unsigned char cursor_addr){
;	-----------------------------------------
...
;	Peephole 253.a	replaced lcall/ret with ljmp
	ljmp	_lcdgotoaddr
00110$:
;	LCD.c:142: else if(cursor_addr == 0xCF){
;	genCmpEq
;	gencjneshort
;	Peephole 112.b	changed ljmp to sjmp
;	Peephole 198.b	optimized misc jump sequence
...
;	Peephole 253.a	replaced lcall/ret with ljmp
	ljmp	_lcdgotoaddr
00107$:
;	LCD.c:145: else if(cursor_addr == 0x9F){
;	genCmpEq
;	gencjneshort
;	Peephole 112.b	changed ljmp to sjmp
;	Peephole 198.b	optimized misc jump sequence
...
;	Peephole 253.a	replaced lcall/ret with ljmp
	ljmp	_lcdgotoaddr
00104$:
;	LCD.c:148: else if(cursor_addr == end_address){
;	genAssign
...
;------------------------------------------------------------
;------------------------------------------------------------
;	LCD.c:154: void lcdclear(){
;	-----------------------------------------
;	 function lcdclear
;	-----------------------------------------
_lcdclear:
;	LCD.c:155: check_busy_flag();
;	genCall
	lcall	_check_busy_flag
;	LCD.c:156: CMD_Write(0x01);
;	genCall
	mov	dpl,#0x01
;	Peephole 253.b	replaced lcall/ret with ljmp
	ljmp	_CMD_Write
...
;------------------------------------------------------------
;	LCD.c:163: void lcdputch(unsigned char cc){
;	-----------------------------------------
;	 function lcdputch
;	-----------------------------------------
_lcdputch:
;	genReceive
	...
	movx	@dptr,a
;	LCD.c:165: check_busy_flag();
;	genCall
	lcall	_check_busy_flag
;	LCD.c:169: if(cc != '\0' && cc != '\r' && cc!= '\n'){
;	genAssign
	mov	dptr,#_lcdputch_cc_1_1
	movx	a,@dptr
;	genCmpEq
...
;	Peephole 251.b	replaced sjmp to ret with ret
	ret
00112$:
;	LCD.c:170: lcdgotoaddr(lcd_address);
;	genAssign
	mov	dptr,#_lcd_address
	movx	a,@dptr
;	genCall
...
;	Peephole 244.c	loading dpl from a instead of r3
	...
	lcall	_lcdgotoaddr
	pop	ar2
;	LCD.c:171: temp_addr = read_cursor_addr();
;	genCall
	push	ar2
...
;	Peephole 236.a	used r2 instead of ar2
	add	a,r2
	movx	@dptr,a
;	LCD.c:189: wrap_cursor(temp_addr);
;	genCall
	mov	dpl,r3
;	Peephole 253.c	replaced lcall with ljmp
	ljmp	_wrap_cursor
...
;------------------------------------------------------------
;	LCD.c:195: void lcdputchcustom(unsigned char cc){
;	-----------------------------------------
...
;	genAssign
	clr	_P1_4
;	LCD.c:201: delay_ms(2);
;	genCall
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0002
	lcall	_delay_ms
;	LCD.c:205: *WR_LCD_INSTR = cc;
;	genAssign
	mov	r2,#0x12
	mov	r3,#0x80
;	genAssign
...
;------------------------------------------------------------
;	LCD.c:211: void lcdputchtimer(unsigned char cc){
;	-----------------------------------------
...
;	genAssign
	clr	_P1_4
;	LCD.c:217: delay_ms(2);
;	genCall
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0002
	lcall	_delay_ms
;	LCD.c:220: if(cc != '\0' && cc != '\r' && cc!= '\n'){
;	genAssign
	mov	dptr,#_lcdputchtimer_cc_1_1
	movx	a,@dptr
;	genCmpEq
...
;------------------------------------------------------------
;	LCD.c:228: void lcdputstr(char *ss){
;	-----------------------------------------
;	 function lcdputstr
;	-----------------------------------------
_lcdputstr:
...
;------------------------------------------------------------
;	LCD.c:259: void lcd_cgram_hexdump(void){
;	-----------------------------------------
;	 function lcd_cgram_hexdump
;	-----------------------------------------
_lcd_cgram_hexdump:
;	LCD.c:261: printf_tiny("\rHEX DUMP FOR LCD CGRAM.\n\r(All values are in HEX FORMAT)\n");
;	genIpush
	mov	a,#__str_0
	push	acc
	mov	a,#(__str_0 >> 8)
...
;	genCall
	...
	pop	ar3
	pop	ar2
;	LCD.c:268: for(j=16*i; j<((i*16)+16); j++){
;	genAssign
;	genMult
;	genMultOneByte
...
;	genAssign
	setb	_P1_4
;	LCD.c:276: my_print(*RD_LCD_INSTR, 2);
;	genPointerGet
;	genFarPointerGet
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x8011
...
;------------------------------------------------------------
;	LCD.c:286: void lcd_ddram_hexdump(void){
;	-----------------------------------------
;	 function lcd_ddram_hexdump
;	-----------------------------------------
_lcd_ddram_hexdump:
;	LCD.c:289: temp_addr = read_cursor_addr();
;	genCall
	lcall	_read_cursor_addr
	mov	r2,dpl
;	LCD.c:290: lcdgotoxy(0,0);
;	genAssign
	mov	dptr,#_lcdgotoxy_PARM_2
;	Peephole 181	changed mov to clr
	clr	a
...
;	genCall
	...
	lcall	_lcdgotoxy
	pop	ar2
;	LCD.c:291: printf_tiny("\rHEX DUMP FOR LCD DDRAM.\n\r(All values are in HEX FORMAT)\n");
;	genIpush
	push	ar2
	mov	a,#__str_5
	push	acc
...
;	genCall
	...
	pop	ar3
	pop	ar2
;	LCD.c:296: temp = (read_cursor_addr() & 0x7F);
;	genCall
	push	ar2
	push	ar3
	lcall	_read_cursor_addr
...
;	genAssign
	setb	_P1_4
;	LCD.c:311: my_print(*RD_LCD_INSTR, 2);
;	genPointerGet
;	genFarPointerGet
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x8011
...
;	genCall
	...
	dec	sp
	pop	ar2
;	LCD.c:318: lcdgotoaddr(temp_addr);
;	genCall
	mov	dpl,r2
;	Peephole 253.b	replaced lcall/ret with ljmp
	ljmp	_lcdgotoaddr
...
;------------------------------------------------------------
;	LCD.c:323: void lcdcreatechar(unsigned char ccode, unsigned char row_vals[]){
;	-----------------------------------------
...
;	genReceive
	...
	movx	@dptr,a
;	LCD.c:326: lcdgotoaddr(lcd_address);
;	genAssign
	mov	dptr,#_lcd_address
	movx	a,@dptr
;	genCall
...
;	Peephole 244.c	loading dpl from a instead of r2
	mov	dpl,a
	lcall	_lcdgotoaddr
;	LCD.c:327: temp_addr = read_cursor_addr();
;	genCall
	lcall	_read_cursor_addr
	mov	r2,dpl
;	LCD.c:328: lcdgotocgramaddr(ccode);
;	genAssign
	mov	dptr,#_lcdcreatechar_ccode_1_1
	movx	a,@dptr
;	genCall
...
;	LCD.c:330: lcdputchcustom(row_vals[i]);
;	genPlus
...
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00101$
00104$:
;	LCD.c:334: lcdgotoaddr(lcd_address);
;	genAssign
	mov	dptr,#_lcd_address
	movx	a,@dptr
;	genCall
...
;	Peephole 182.b	used 16 bit load of dptr
	...
	lcall	_delay_ms
	pop	ar2
;	LCD.c:337: lcdputchcustom(ccode);
;	genAssign
	mov	dptr,#_lcdcreatechar_ccode_1_1
	movx	a,@dptr
;	genCall
...
;	Peephole 236.a	used r3 instead of ar3
	add	a,r3
	movx	@dptr,a
;	LCD.c:340: wrap_cursor(temp_addr);
;	genCall
	mov	dpl,r2
;	Peephole 253.b	replaced lcall/ret with ljmp
	ljmp	_wrap_cursor
...
;------------------------------------------------------------
;	LCD.c:346: void custom_char(){
;	-----------------------------------------
;	 function custom_char
;	-----------------------------------------
_custom_char:
;	LCD.c:348: unsigned char cgram_data[8]={0,0,0,0,0,0,0,0};
;	genPointerSet
;     genFarPointerSet
...
;	LCD.c:349: do{
00108$:
;	LCD.c:350: printf_tiny("\rEnter character code(between 0 and 7). Press backspace to exit\n\r");
;	genIpush
	mov	a,#__str_6
	push	acc
	mov	a,#(__str_6 >> 8)
...
;	genCall
	...
	dec	sp
	dec	sp
;	LCD.c:351: char_code = rx_data_char();
;	genCall
	lcall	_rx_data_char
	mov	r2,dpl
;	genAssign
...
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00161$
00166$:
;	LCD.c:355: if(char_code >= '0' && char_code <= '7'){
;	genAssign
	mov	ar3,r2
;	genCmpLt
;	genCmp
...
;	LCD.c:356: char_code = char_code - 0x30;
;	genMinus
	mov	a,r2
	add	a,#0xd0
;	genAssign
...
;	Peephole 100	removed redundant mov
	movx	@dptr,a
;	LCD.c:357: printf_tiny("\rCharacter code = %d\n", char_code);
;	genCast
	mov	r3,#0x00
;	genIpush
	push	ar2
...
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00109$
00104$:
;	LCD.c:361: printf_tiny("\rInvalid input\n");
;	genIpush
	mov	a,#__str_8
	push	acc
	mov	a,#(__str_8 >> 8)
...
;	genCall
	...
	dec	sp
00109$:
;	LCD.c:363: }while(char_code < 0  || char_code > 7);
;	genAssign
	mov	dptr,#_custom_char_char_code_1_1
	movx	a,@dptr
;	genCmpGt
...
00124$:
;	LCD.c:370: invalid_bit = 0;
;	genAssign
	mov	dptr,#_custom_char_invalid_bit_1_1
;	Peephole 181	changed mov to clr
	clr	a
	movx	@dptr,a
;	LCD.c:371: printf_tiny("\rEnter 5 pixel values for row %d (Format: C4 C3 C2 C1 C0). Press backspace to exit\n\n\r", i);
;	genCast
...
;	LCD.c:377: break;
	ljmp	00125$
00118$:
;	LCD.c:379: else if(temp == '0' || temp == '1' ){
;	genCmpEq
;	gencjneshort
	cjne	r7,#0x30,00179$
;	Peephole 112.b	changed ljmp to sjmp
...
00113$:
;	LCD.c:381: cgram_data[i] |= (((temp - 0x30) << (4-j)) & 0x1F);
;	genIpush
	push	ar2
;	genPlus
...
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00122$
00114$:
;	LCD.c:384: invalid_bit = 1;
;	genAssign
	mov	dptr,#_custom_char_invalid_bit_1_1
	mov	a,#0x01
	movx	@dptr,a
;	LCD.c:385: printf_tiny("\rInvalid input. Please enter valid input\n");
;	genIpush
	push	ar2
	push	ar4
	push	ar6
...
;	Peephole 236.a	used r3 instead of ar3
	...
	ljmp	00120$
00125$:
;	LCD.c:389: }while(invalid_bit == 0x01);
;	genAssign
	mov	dptr,#_custom_char_invalid_bit_1_1
	movx	a,@dptr
	mov	r3,a
...
;	LCD.c:394: temp = ((cgram_data[k]>>(4-j)) & 0x01);
;	genPointerGet
;	genFarPointerGet
	mov	dpl,r4
	mov	dph,r5
...
;	LCD.c:403: lcdcreatechar(char_code, cgram_data);
;	genAssign
	mov	dptr,#_custom_char_char_code_1_1
	movx	a,@dptr
	mov	r2,a
