...
;	genCall
	...
	dec	sp
	dec	sp
;	misc.c:91: printf_tiny("\rD:Press D to Configure I/O Expander\n");
;	genIpush
	mov	a,#__str_16
	push	acc
	mov	a,#(__str_16 >> 8)
...
;	genCall
	...
	dec	sp
	dec	sp
;	misc.c:92: printf_tiny("\rQ:Press Q to get status of the I/O Expander\n");
;	genIpush
	mov	a,#__str_17
	push	acc
	mov	a,#(__str_17 >> 8)
...
;	genCall
	...
	dec	sp
	dec	sp
;	misc.c:93: printf_tiny("\rW:Press W to an output pin of the I/O Expander\n");
;	genIpush
	mov	a,#__str_18
	push	acc
	mov	a,#(__str_18 >> 8)
